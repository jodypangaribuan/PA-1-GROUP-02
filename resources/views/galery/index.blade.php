                    ...
                    <div class="d-flex flex-row justify-content-between">
                        ...
                        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            ...
                            <div class="modal-content">
                                ...
                                <form role="form text-left" method="POST" action="{{ route('galery-store') }}" enctype="multipart/form-data">
                                    @csrf
                                ...
                                @foreach ($galery as $item)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <img src="{{ asset('assets/img/galery/'.$item->img) }}" style="max-width: 300px" alt="">
                                        </td>
                                        <td class="text-center">
...
<div class="modal fade" id="modaledit{{ $item2->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
        ...
        <form role="form text-left" method="POST" action="{{ route('galery-update',$item2->id) }}" enctype="multipart/form-data">
            @csrf
        <div class="modal-body">
            <div class="mb-3">
                <label for="">Foto</label>
                <br>
                <img src="{{ asset('assets/img/galery/'.$item2->img) }}" style="max-width: 100px" alt="">
                <br>
                <input type="file" class="form-control" placeholder="foto" name="foto" id="foto" value="{{ old('foto') }}" required>
                @error('foto')
                <p class="text-danger text-xs mt-2">{{ $message }}</p>
